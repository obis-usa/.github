...
Interested in helping out the OBIS-USA community?
Have a few minutes to tackle an issue? Or improve the documentation?
In this guide we will get you setup and integrated into contributing to OBIS-USA!

## Introduction

First off, thank you for considering contributing to OBIS-USA.
It's people like you that make the OBIS-USA community useful and successful.
...
[code of conduct](https://github.com/OBIS-USA/.github/blob/main/CODE_OF_CONDUCT.md).
...
The easiest way to get involved is to report issues you encounter when using OBIS-USA Software or by
